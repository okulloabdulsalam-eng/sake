...
const SEARCH_DATA = [
    ...
    {
        title: "Home",
        description: "KIUMA - Kampala International University Muslim Association. Your guide to Islamic values, programs, and activities.",
        url: "index.html",
        category: "page",
    ...
    {
        title: "About KIUMA",
        description: "Learn about Kampala International University Muslim Association, our mission, vision, and history.",
        url: "about.html",
        category: "page",
    ...
    // Activities - Specific
    {
        title: "Kizumu Tahfiz Charity Visit — FINISHED",
        description: "Thank you for your support! Results and media released soon.",
        url: "activities.html#charity-visit",
        category: "activity",
        keywords: ["kizumu", "tahfiz", "charity", "visit", "support", "education", "orphans", "finished"],
        icon: "fa-heart"
    },
    {
